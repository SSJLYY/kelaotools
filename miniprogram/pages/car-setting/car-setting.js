...
Page({
  data: { darkMode: false,
    ...
    carSeries: [
      {
        id: '001', name: '极氪 001', desc: '豪华猎装轿跑',
        emoji: '⚡', iconBg: '#EDE9FE', comingSoon: false,
      },
      {
        id: '001-fr', name: '极氪 001 FR', desc: '纯电猎装超跑',
        emoji: '🏁', iconBg: '#FEF2F2', comingSoon: false,
      },
      {
        id: '007', name: '极氪 007', desc: '纯电豪华轿车',
        emoji: '🚗', iconBg: '#DBEAFE', comingSoon: false,
      },
      {
        id: 'x', name: '极氪 X', desc: '新奢全能SUV',
        emoji: '🚙', iconBg: '#FFF7ED', comingSoon: false,
      },
      {
        id: '009', name: '极氪 009', desc: '豪华纯电MPV',
        emoji: '👑', iconBg: '#FEF3C7', comingSoon: false,
      },
      {
        id: '009-grand', name: '极氪 009 光辉', desc: '四座超豪华MPV',
        emoji: '💎', iconBg: '#FEF3C7', comingSoon: false,
      },
      {
        id: 'mix', name: '极氪 MIX', desc: '新奢全场景五座',
        emoji: '🔮', iconBg: '#D1FAE5', comingSoon: false,
      },
      {
        id: '7x', name: '极氪 7X', desc: '豪华大五座SUV',
        emoji: '🚙', iconBg: '#E8F4FD', comingSoon: true,
      },
    ],
